...
public class StatisticPickerUI extends OptionMenu {
    ...
    protected static final InventoryItem QUIT = new InventoryItem(49, Material.REDSTONE, String.valueOf(ChatColor.RED) + ChatColor.BOLD + TranslationData.translate("menu.save_exit"), "");
